...
export default function LoggedInContent({ me, closeMenu }: Props) {
  ...
  return (
    <>
      ...
      <DropDown.Button variant="list" onClick={pushProfilePage} className="flex w-full gap-2 px-1">
        <Icon view="0 -960 960 960" size={18}>
      ...
      <Line className="my-2" />
      <DropDown.Button variant="list" onClick={() => signOut()} className="flex gap-2 px-1">
        <Icon view="0 -960 960 960" size={18}>
