...
import { useTheme } from "@/app/_store/use-theme";
import { DropDown } from "@/shared/components/DropDown";
import Icon from "@/shared/components/Icon";
import { List } from "@/shared/components/List";
import type { EmotionLevel } from "@/shared/types/enums/index";
      ...
      >
        ...
        {selectedEmotion === emotion.percent && (
          <Icon
            view="0 -960 960 960"
            size={18}
            className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 text-white"
          >
