...
export const ArticleDetailEmotionButton = () => {
  return (
    <TooltipProvider>
      <div className="flex flex-col items-center gap-2">
        <div className="flex items-center gap-2">
          <div className="relative flex size-full items-center justify-start">
            <div className="flex place-items-center gap-2 sm:flex-col">
              <div className="flex items-center gap-2">
                <div className="relative flex size-full items-center justify-start">
                  <div className="flex place-items-center gap-2 sm:flex-col">
                    <div className="flex items-center gap-2">
                      <div className="relative flex size-full items-center justify-start">
                        <div className="flex place-items-center gap-2 sm:flex-col"></div>
                      </div>
                    </div>
                  </div>
                </div>
...
//             >
//               {selectedEmotion && (
//                   <TextDisplay type="caption" size="xs" className="absolute top-0">
