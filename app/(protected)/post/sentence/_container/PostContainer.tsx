...
import EmotionPickerWithDropDown from '../_components/EmotionPickerWithDropDown'
          ...
          <div className="flex items-center gap-4">
            <DropDown.Root>
              ...
              <DropDown.Content
                ...
                className="p-0"
              >
                <DropDown.Button onClick={() => changeAccessType('public')}>
                  공개
                </DropDown.Button>
                <DropDown.Button onClick={() => changeAccessType('private')}>
                  비공개
                </DropDown.Button>
              </DropDown.Content>
            </DropDown.Root>
