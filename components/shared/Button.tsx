...
const BUTTON_VARIANTS = cva('flex items-center justify-center transition', {
  variants: {
    active: {
      primary:
        'rounded-md border border-gray-800 bg-gray-800 font-semibold text-white hover:opacity-85 active:animate-click',
      secondary:
        'rounded-md border border-gray-400 hover:opacity-85 active:animate-click',
